...
class DeleteAllUseCase <E,D: BaseDao<E>,R: BaseRepository<E,D>> @Inject constructor(private val repository:R): CompletableUseCase()  {

     fun deleteAll(observer: CompletableObserver) = repository.deleteAll().also { execute(it, observer) }
